...
class TestComputeMetricsVsFalseAlarmRates(unittest.TestCase):
    ...
    def test_calculation_exact(self):
        ...
        true_alarm_rates, false_alarm_rates, avg_warning_times = compute_metrics_vs_false_alarm_rates(predictions, outcomes, required_warning_time, unique_thresholds, 'sthr')
